...
const hostDaemonOnlineRpcResponseSuccessSchema = z.discriminatedUnion(
  ...
  [
    ...
    onlineRpcResponseSuccessSchemaFor("simulator.status"),
    onlineRpcResponseSuccessSchemaFor("simulator.attach"),
    onlineRpcResponseSuccessSchemaFor("simulator.lease"),
    onlineRpcResponseSuccessSchemaFor("simulator.control"),
    onlineRpcResponseSuccessSchemaFor("simulator.stop"),
    onlineRpcResponseSuccessSchemaFor("simulator.accessibility"),
    onlineRpcResponseSuccessSchemaFor("simulator.screenshot"),
    ...
    onlineRpcResponseSuccessSchemaFor("provider_auth.start"),
    onlineRpcResponseSuccessSchemaFor("provider_auth.submit_code"),
    onlineRpcResponseSuccessSchemaFor("workspace.discover_repos"),
    onlineRpcResponseSuccessSchemaFor("workspace.status"),
    onlineRpcResponseSuccessSchemaFor("workspace.find_available_port"),
    onlineRpcResponseSuccessSchemaFor("workspace.port_status"),
    onlineRpcResponseSuccessSchemaFor("workspace.docker_mounts"),
    onlineRpcResponseSuccessSchemaFor("workspace.docker_control"),
    onlineRpcResponseSuccessSchemaFor("workspace.docker_path_activity"),
    onlineRpcResponseSuccessSchemaFor("workspace.github_deployments"),
    ...
    commandRpcResponseSuccessSchemaFor("workspace.pull_request_checks_rerun"),
