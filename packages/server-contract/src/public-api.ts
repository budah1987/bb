...
import {
  ...
  environmentDockerControlRequestSchema,
  environmentPathsQuerySchema,
  environmentPreviewBypassRequestSchema,
  environmentPreviewPortRequestSchema,
...
export const publicApiRoutes = {
  ...
  environments: {
    ...
    dockerControl: defineRoute({
      path: "/environments/:id/docker-control",
      method: "post",
      request: jsonRequest<PathId, EnvironmentDockerControlRequest>(
        environmentDockerControlRequestSchema,
      ),
      response: jsonResponse<EnvironmentDockerControlResponse>(),
    }),
    ...
    startDevServer: defineRoute({
      path: "/environments/:id/dev-servers/start",
      method: "post",
      request: jsonRequest<PathId, StartEnvironmentDevServerRequest>(
        startEnvironmentDevServerRequestSchema,
      ),
      response: jsonResponse<TerminalSession>({ status: 201 }),
    }),
    sharePreviewPort: defineRoute({
      path: "/environments/:id/previews/share",
      method: "post",
      request: jsonRequest<PathId, EnvironmentPreviewPortRequest>(
        environmentPreviewPortRequestSchema,
      ),
      response: jsonResponse<EnvironmentPreviewShareResponse>(),
    }),
    unsharePreviewPort: defineRoute({
      path: "/environments/:id/previews/unshare",
      method: "post",
      request: jsonRequest<PathId, EnvironmentPreviewPortRequest>(
        environmentPreviewPortRequestSchema,
      ),
      response: jsonResponse<EnvironmentPreviewUnshareResponse>(),
    }),
    bypassPreviewProtection: defineRoute({
      path: "/environments/:id/previews/bypass",
      method: "post",
      request: jsonRequest<PathId, EnvironmentPreviewBypassRequest>(
        environmentPreviewBypassRequestSchema,
      ),
      response: jsonResponse<EnvironmentPreviewBypassResponse>(),
    }),
